...
HTTP_AUTH_DIGEST_MODULE_URI="https://codeload.github.com/${HTTP_AUTH_DIGEST_MODULE_AUTHOR}/${HTTP_AUTH_DIGEST_MODULE_P}/tar.gz/${HTTP_AUTH_DIGEST_MODULE_SHA1} -> ${HTTP_AUTH_DIGEST_MODULE_P}-${HTTP_AUTH_DIGEST_MODULE_SHA1}.tar.gz"
...
HTTP_CLOJURE_MODILE_AUTHOR="nginx-clojure"
HTTP_CLOJURE_MODULE_P="nginx-clojure"
HTTP_CLOJURE_MODULE_SHA1="ec59f73b712010c05700bd7e906815759e8665b0"
