...
HTTP_TCP_PROXY_MODULE_SHA1="eec00d52366e21e9b49286e0a0b637433490819e"
HTTP_TCP_PROXY_MODULE_URI="http://rms3.creosotehill.org/mirror/gentoo/distfiles/nginx_tcp_proxy_module-${HTTP_TCP_PROXY_MODULE_SHA1}.tar.gz"
HTTP_TCP_PROXY_MODULE_WD="${WORKDIR}/nginx_tcp_proxy_module-${HTTP_TCP_PROXY_MODULE_SHA1}"

# http_ajp ( http://github.com/yaoweibin/nginx_ajp_module, BSD-2 license )
HTTP_AJP_MODULE_AUTHOR="yaoweibin"
HTTP_AJP_MODULE_P="nginx_ajp_module"
HTTP_AJP_MODULE_SHA1="12c852ce7b90ace587b34da7a2958d59e65f64b2"
HTTP_AJP_MODULE_URI="http://rms3.creosotehill.org/mirror/gentoo/distfiles/nginx_ajp_module-${HTTP_AJP_MODULE_SHA1}.tar.gz"
...
HTTP_ACCEPT_LANGUAGE_MODULE_P="nginx_language_accept_module"
HTTP_ACCEPT_LANGUAGE_MODULE_SHA1="2f69842f83dac77f7d98b41a2b31b13b87aeaba7"
HTTP_ACCEPT_LANGUAGE_MODULE_URI="http://rms3.creosotehill.org/mirror/gentoo/distfiles/nginx_accept_language_module-${HTTP_ACCEPT_LANGUAGE_MODULE_SHA1}.tar.gz"
HTTP_ACCEPT_LANGUAGE_MODULE_WD="${WORKDIR}/giom-nginx_accept_language_module-${HTTP_ACCEPT_LANGUAGE_MODULE_SHA1}"

# http_auth_digest (https://github.com/samizdatco/nginx-http-auth-digest, BSD license)
HTTP_AUTH_DIGEST_MODULE_AUTHOR="samizdatco"
HTTP_AUTH_DIGEST_MODULE_P="nginx-http-auth-digest"
HTTP_AUTH_DIGEST_MODULE_SHA1="bd1c86a8c838bfd63de67c896e2e36ae1070cdb3"
HTTP_AUTH_DIGEST_MODULE_URI="http://rms3.creosotehill.org/mirror/gentoo/distfiles/nginx-http-auth-digest-${HTTP_AUTH_DIGEST_MODULE_SHA1}.tar.gz"
HTTP_AUTH_DIGEST_MODULE_WD="${WORKDIR}/nginx-http-auth-digest-${HTTP_AUTH_DIGEST_MODULE_SHA1}"
...
HTTP_CLOJURE_MODULE_SHA1="14b0dbdf0c7623cf3d3871adbe9660ec276564fd"
HTTP_CLOJURE_MODULE_URI="http://rms3.creosotehill.org/mirror/gentoo/distfiles/${HTTP_CLOJURE_MODULE_P}-${HTTP_CLOJURE_MODULE_SHA1}.tar.gz"
...
src_configure() {
	...
	if use nginx_modules_http_auth_digest; then
		http_enabled=1
		myconf+=" --add-module=${HTTP_AUTH_DIGEST_MODULE_WD}"
	fi

	if use nginx_modules_http_clojure; then
		http_enabled=1
		myconf+=" --add-module=${HTTP_CLOJURE_MODULE_WD}"
	fi
