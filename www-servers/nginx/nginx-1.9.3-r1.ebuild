...
HTTP_AJP_MODULE_P="ngx_http_ajp_module"
HTTP_AJP_MODULE_SHA1="bf6cd93f2098b59260de8d494f0f4b1f11a84627"
HTTP_AJP_MODULE_URI="https://codeload.github.com/yaoweibin/nginx_ajp_module/tar.gz/${HTTP_AJP_MODULE_SHA1} -> ${HTTP_AJP_MODULE_P}-${HTTP_AJP_MODULE_SHA1}.tar.gz"
...
HTTP_TCP_PROXY_MODULE_SHA1="f2156eff9f6621aaf601eaa8dee40c6820dea0b0"
HTTP_TCP_PROXY_MODULE_URI="https://codeload.github.com/${HTTP_TCP_PROXY_MODULE_P}/${HTTP_TCP_PROXY_MODULE_P}/tar.gz/${HTTP_TCP_PROXY_MODULE_SHA1} -> ${HTTP_TCP_PROXY_MODULE_P}-${HTTP_TCP_PROXY_MODULE_SHA1}.tar.gz"
...
HTTP_ACCEPT_LANGUAGE_MODULE_URI="https://codeload.github.com/${HTTP_ACCEPT_LANGUAGE_MODULE_AUTHOR}/${HTTP_ACCEPT_LANGUAGE_MODULE_P}/tar.gz/${HTTP_ACCEPT_LANGUAGE_MODULE_SHA1} -> ${HTTP_ACCEPT_LANGUAGE_MODULE_P}-${HTTP_ACCEPT_LANGUAGE_MODULE_SHA1}.tar.gz"
...
HTTP_AUTH_DIGEST_MODULE_URI="https://codeload.github.com/${HTTP_AUTH_DIGEST_MODULE_P}/${HTTP_AUTH_DIGEST_MODULE_P}/tar.gz/${HTTP_AUTH_DIGEST_MODULE_SHA1} -> ${HTTP_AUTH_DIGEST_MODULE_P}-${HTTP_AUTH_DIGEST_MODULE_SHA1}.tar.gz"
...
HTTP_CLOJURE_MODULE_SHA1="17c98149cf2e91a36754d34208aba6d47af56afd"
