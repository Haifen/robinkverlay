...
ALL_LLVM_EXPERIMENTAL_TARGETS=( AVR WebAssembly )
ALL_LLVM_EXPERIMENTAL_TARGETS=( "${ALL_LLVM_EXPERIMENTAL_TARGETS[@]/#/llvm_experimental_targets_}" )
LLVM_EXPERIMENTAL_TARGET_USEDEPS=${ALL_LLVM_EXPERIMENTAL_TARGETS[@]/%/?}
...
RDEPEND="
	~sys-devel/llvm-${PV}:${SLOT}=[debug=,${LLVM_TARGET_USEDEPS// /,},${LLVM_EXPERIMENTAL_TARGET_USEDEPS// /,},${MULTILIB_USEDEP}]
	static-analyzer? (
		dev-lang/perl:*
...
REQUIRED_USE="${PYTHON_REQUIRED_USE}
	|| ( ${ALL_LLVM_TARGETS[*]} ${ALL_LLVM_EXPERIMENTAL_TARGETS[*]} )
	multitarget? ( ${ALL_LLVM_TARGETS[*]} ${ALL_LLVM_EXPERIMENTAL_TARGETS[*]} )"
