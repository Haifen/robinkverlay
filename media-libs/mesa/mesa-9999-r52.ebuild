...
RADEON_CARDS="amdgpu r100 r200 r300 r600 radeon radeonsi"
...
IUSE="${IUSE_VIDEO_CARDS}
	...
	+nptl opencl osmesa pax_kernel openmax openvg pic selinux +udev vaapi vdpau
...
REQUIRED_USE="
	...
	video_cards_amdgpu?   ( gallium llvm )
...
DEPEND="${RDEPEND}
	llvm? (
		...
		video_cards_amdgpu? ( sys-devel/llvm[video_cards_radeon] )
	)
	opencl? (
				>=sys-devel/llvm-3.4.2:=[${MULTILIB_USEDEP}]
