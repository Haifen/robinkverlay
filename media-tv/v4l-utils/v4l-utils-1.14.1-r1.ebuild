...
## sysmacros.patch is for bug 580910, sdlcam-libjpeg.patch is for bug 644464
PATCHES=( "${FILESDIR}"/${PN}-1.14.1-sysmacros.patch
		  "${FILESDIR}"/${PN}-sdlcam-Only-build-if-using-libjpeg.patch )
